        ...
        $pages = [
            [
                ...
                'content' =>
                    ...
                    Html::tag(
                        'div',
                        '[room-categories title="Room Type" subtitle="Inspired Loading" background_image="general/bg.jpg" enable_lazy_loading="yes"][/room-categories]'
                    ) .
                    Html::tag(
                        'div',
                        '[hotel-featured-features title="The Thin Escape" subtitle="Miranda has everything for your trip & every single things." button_text="Take a tour" button_url="/rooms" enable_lazy_loading="yes"][/hotel-featured-features]'
                    ) .
