...
class ThemeOptionSeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        Setting::set(ThemeOption::prepareFromArray([
            'site_title' => 'Kedas Hotel & Resorts',
            'seo_description' => 'Kedas Hotel & Resorts - Hotel & Resort Multilingual Booking System',
            'copyright' => '©%Y Kedas Hotel & Resorts. All right reserved.',
            ...
            'email' => 'info_cs@kedasresort.com',
            'address' => 'Kelawi, Bakauheni, South Lampung Regency, Lampung 35592',
            'hotline' => '+62-853-8383-8862',
            'news_banner' => 'general/banner-news.jpg',
            'rooms_banner' => 'general/banner-news.jpg',
            'term_of_use_url' => '#',
            'privacy_policy_url' => '#',
            'preloader_enabled' => 'no',
            'about-us' => 'Experience the ultimate in traditional and comfort at Kedas Hotel &amp; Resort - your premier destination for an unforgettable stay.',
