...
;(function ($) {
    ...
    mirandaDoc = {
        ...
        initBannerSlider(container = null) {
            let bannerSliderOne = container ? $(container).find('#bannerSlider') : $('#bannerSlider')

            if (!bannerSliderOne.length || bannerSliderOne.hasClass('slick-initialized')) {
                return
            }
        ...
        initRoomSlider(container = null) {
            let sliderImg = container ? $(container).find('.rooms-slider-one') : $('.rooms-slider-one'),
                sliderContent = container ? $(container).find('.room-content-slider') : $('.room-content-slider'),
                countStatus = container ? $(container).find('.slider-count') : $('.slider-count'),
                countBig = container ? $(container).find('.slider-count-big') : $('.slider-count-big')
        ...
        initTestimonialSlider(container = null) {
            let tslider = container ? $(container).find('.testimonial-slider') : $('.testimonial-slider')
        ...
        initLatestPostSlider(container = null) {
            let tslider = container ? $(container).find('.latest-post-slider') : $('.latest-post-slider')
            let arrows = container ? $(container).find('.latest-post-arrow') : $('.latest-post-arrow')
        ...
        initPopupVideo(container = null) {
            if (jQuery().magnificPopup) {
                let popupVideos = container ? $(container).find('.popup-video') : $('.popup-video')
    ...
    $(document).ready(function () {
        $('.service-item').on('change', function () {
            ...
            let $selectedPaymentMethod = $(document)
                .find('.payment-checkout-form .list_payment_method input[name="payment_method"]:checked')
                .val()
