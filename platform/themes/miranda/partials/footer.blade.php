        ...
        <footer class="footer-two">
            <div @class([
                'footer-widget-area pt-100 pb-50',
                'light-theme' => theme_option('footer_style', 'dark') === 'light',
            ])>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 order-1">
                            <div class="widget site-info-widget mb-50">
                                ...
                                @elseif ($socialLinks = theme_option('social_links'))
                                    <div class="social-links mt-40">
                            ...
                            <div class="widget contact-widget mb-50">
                                ...
                                <div class="contact-lists">
                                    ...
                                    <div class="contact-box">
                                        ...
                                        <div class="desc">
                                            <p class="title">{{ __('Office Address') }}</p>
                    ...
                    <div class="row align-items-center">
                        @if ($copyright = Theme::getSiteCopyright())
                            <div class="col-lg-6 col-md-5 order-2 order-md-1">
                                <p class="copyright-text copyright-two">{!! $copyright !!}</p>
                            </div>
                        @endif
