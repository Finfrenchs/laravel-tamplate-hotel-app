...
<head>
    ...
    <style>
        :root {
            ...
            --primary-color: {{ theme_option('primary_color', '#bead8e') }};
...
<body {!! Theme::bodyAttributes() !!}>
    ...
    <div class="offcanvas-wrapper">
        ...
        <div class="offcanvas-widget">
            ...
            @if (is_plugin_active('hotel') && !theme_option('room_search_hide', false))
                <div class="widget search-widget">
                    ...
                    <form action="{{ route('public.rooms') }}">
                        <input type="text" name="q" value="{{ BaseHelper::stringify(old('q', request()->query('q'))) }}" placeholder="{{ __('Enter keyword') }}...">
            ...
            <div class="widget nav-widget">
                <h5 class="widget-title">{{ __('Account') }}</h5>
