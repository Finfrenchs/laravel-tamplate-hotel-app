                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-10">
                        <div class="place-box mt-30">
                            <div class="place-bg-wrap">
                                <div
                                    class="place-bg"
                                    style="background-image: url({{ RvMedia::getImageUrl($gallery->image, '380x280', false, RvMedia::getDefaultImage()) }});"
                                ></div>
                            </div>
                            <div class="desc">
                                <h4><a href="{{ $gallery->url }}">{{ $gallery->name }}</a></h4>
                                <span class="time">{{ Theme::formatDate($gallery->created_at) }}</span>
                            </div>
                        </div>
                    </div>
                @endforeach
