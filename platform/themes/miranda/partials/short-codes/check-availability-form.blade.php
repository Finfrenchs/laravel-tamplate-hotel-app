                            ...
                            <div class="col-lg-3 col-md-12">
                                <div class="inputs-filed mt-30">
                                    ...
                                    <button
                                        ...
                                        class="text-truncate"
                                        type="button"
                                        data-target="#toggle-guests-and-rooms"
                                    >
                                        <span
                                            data-bb-toggle="filter-adults-count"
                                            class="mr-1"
                                        >1</span> {{ __('Adult(s)') }},
                                        <span
                                            data-bb-toggle="filter-children-count"
                                            class="mr-1"
                                        >0</span> {{ __('Child(ren)') }},
                                        <span
                                            data-bb-toggle="filter-rooms-count"
                                            class="mr-1"
                                        >1</span> {{ __('Room(s)') }}
                                    </button>
                                    <div
                                        class="custom-dropdown dropdown-menu p-3"
                                        id="toggle-guests-and-rooms"
                                    >
