            ...
            <div class="col-lg-8">
                <div class="booking-form-body room-details">
                    ...
                    >
                        ...
                        @if (!$customer->id)
                            <p class="mb-20">{{ __('Already have an account?') }} <a
                            ...
                            <div class="form-group mb-20 custom-checkbox d-block">
                                <label for="terms_conditions">
                                    ...
                                    @if ($privacyPolicyUrl = theme_option('term_and_privacy_policy_url'))
                                        {!! BaseHelper::clean(
                                            __('I agree to the :link', [
                                                'link' => Html::link(
                                                    $privacyPolicyUrl,
                                                    '&nbsp;' . __('Terms and Privacy Policy'),
                                                    attributes: ['class' => 'text-decoration-underline', 'target' => '_blank'],
                                                ),
                                            ]),
                                        ) !!}
                                    @else
                    ...
                    <div class="booking-info-sidebar">
                        ...
                        <div class="booking-info-body">
                            ...
                            <div>
                                ...
                                <p>{{ __('Price') }}: <span
                                        class="amount-text">{{ format_price($amount) }}</span></p>
                                <p>{{ __('Discount') }}: <span
                                        class="discount-text">{{ format_price($couponAmount) }}</span></p>
                                <p>{{ __('Tax') }}: <span
                                        class="tax-text">{{ format_price($taxAmount) }}</span></p>
                            </div>
                        </div>
                        <div class="pb-20 pt-20 text-center booking-info-total">
                            <p>{{ __('Total') }}: <span
                                    class="total-amount-text">{{ format_price($total) }}</span>
                            </p>
                        </div>
                    </div>
                </div>
